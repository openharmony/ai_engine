...
namespace {
    ...
    const int EXCEPTED_INIT_TIME = 35;
    const int EXCEPTED_PREPARE_TIME = 105;
    const int EXCEPTED_ASYNC_PROCESS_TIME = 53;
    const int EXCEPTED_RELEASE_TIME = 105;
    const int EXCEPTED_DESTROY_TIME = 35;
    const int EXCEPTED_SETOPTION_TIME = 35;
    const int EXCEPTED_GETOPTION_TIME = 35;
